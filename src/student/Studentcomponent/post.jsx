...
const Post = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log(`Query: ${query}, Company: ${company}`);
        setQuery('');
        setCompany('');
    };
    ...
    return (
        <form className="max-w-full mx-auto bg-white p-4 shadow-md rounded-lg" onSubmit={handleSubmit}>
            <fieldset className="mb-2 relative">
                ...
                <button
                    type="submit"
                    className="realtive p-2 text-white bg-blue-300 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
